...
; https://wiki.osdev.org/Interrupt_Vector_Table
	...
	;1 - so it enabled
	;00 - privilege level - kernel
	;0 for interrupt and trap types
	;type: 1110 - x32 interrupt
	; or 1111 - x32 trap
	...
	dw ((pic_master_empty_irq shl 0x30) shr 0x30);34 - irq2 - cascade
	dw 0x8
	db 0
	db 10001110b
	dw (pic_master_empty_irq shr 0x10)

	dw ((pic_master_empty_irq shl 0x30) shr 0x30);35 - irq3 - com2
	dw 0x8
	db 0
	db 10001110b
	dw (pic_master_empty_irq shr 0x10)

	dw ((pic_master_empty_irq shl 0x30) shr 0x30);36 - irq4 - com1
	dw 0x8
	db 0
	db 10001110b
	dw (pic_master_empty_irq shr 0x10)

	dw ((pic_master_empty_irq shl 0x30) shr 0x30);37 - irq5 - lpt
	dw 0x8
	db 0
	db 10001110b
	dw (pic_master_empty_irq shr 0x10)

	dw ((pic_master_empty_irq shl 0x30) shr 0x30);38 - irq6 - floppy disk
	dw 0x8
	db 0
	db 10001110b
	dw (pic_master_empty_irq shr 0x10)

	dw ((pic_master_empty_irq shl 0x30) shr 0x30);39 - irq 7 - lpt1
	dw 0x8
	db 0
	db 10001110b
	dw (pic_master_empty_irq shr 0x10)

	dw ((pic_slave_empty_irq shl 0x30) shr 0x30);40 - begin of pic slave - irq8 - cmos real time clock
	dw 0x8
	db 0
	db 10001110b
	dw (pic_slave_empty_irq shr 0x10)

	dw ((pic_slave_empty_irq shl 0x30) shr 0x30);41
	dw 0x8
	db 0
	db 10001110b
	dw (pic_slave_empty_irq shr 0x10)

	dw ((pic_slave_empty_irq shl 0x30) shr 0x30);42
	dw 0x8
	db 0
	db 10001110b
	dw (pic_slave_empty_irq shr 0x10)

	dw ((pic_slave_empty_irq shl 0x30) shr 0x30);43
	dw 0x8
	db 0
	db 10001110b
	dw (pic_slave_empty_irq shr 0x10)

	dw ((pic_slave_empty_irq shl 0x30) shr 0x30);44 - ps2 mouse
	dw 0x8
	db 0
	db 10001110b
	dw (pic_slave_empty_irq shr 0x10)

	dw ((pic_slave_empty_irq shl 0x30) shr 0x30);45 - fpu
	dw 0x8
	db 0
	db 10001110b
	dw (pic_slave_empty_irq shr 0x10)
	...
	dw ((pic_slave_empty_irq shl 0x30) shr 0x30);47 - secondary ata
	dw 0x8 ;00000000 00001000b
	db 0
	db 10001110b
	dw (pic_slave_empty_irq shr 0x10)
